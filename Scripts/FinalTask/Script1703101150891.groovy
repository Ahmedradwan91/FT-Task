...
Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Afghanistan (1)'), 0)

Mobile.scrollToText('Albania')

Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Albania (1)'), 0)
...
Mobile.verifyElementText(findTestObject('Object Repository/android.widget.ImageView'), '')
